# System Instructions for Conversational Coach Agent Creation
...
### App User Interface
The user interface will have a chat-like setup allowing users to type or paste text as an input. The output will be generated and displayed in the conversation window in the form as shared below --
<Sample Display>
[User] : [user input details]
[Agent]: [output format]
</Sample Display>
The chat interface will have the option of allowing multiple turns of the conversation and should be able to store historical conversations
It is preferred to design the app using streamlit package

### LLM Use
Utilize the Google Gemini LLM for designing the conversational AI agent. The API key will be stored in the project folder but, will not be synced to the Github.